...
class _PasswordDialogState extends State<PasswordDialog> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: const Text('Digite a senha do supervisor'),
      content: Column(
...
class EquipeSupervisaoScreen extends StatelessWidget {
  final List<Widget Function(BuildContext)> buttons = [
        ...
        ElevatedButton(                                                 // Botão melhor equipe
          onPressed: () async {
            ...
            if (isPasswordCorrect == true) {
              Navigator.of(context).pushNamed("/janete-screen");
            }
          ...
          child: Column(
            ...
            children: [
              Image.asset(
                'asset/logosupervisor/janete160.png',
                fit: BoxFit.contain,
                width: 45,
                height: 45,
              ),
        ...
        ElevatedButton(                                                   //Botão equipe sul
          onPressed: () async {
            ...
            if (isPasswordCorrect == true) {
              Navigator.of(context).pushNamed("/leandro-screen");
            }
          ...
          child: Column(
            ...
            children: [
              Image.asset(
                'asset/logosupervisor/leandro160.png',
                fit: BoxFit.contain,
                width: 45,
                height: 45,
              ),
        ...
        ElevatedButton(                                                   //Botão equipe norte
          onPressed: () async {
            ...
            if (isPasswordCorrect == true) {
              Navigator.of(context).pushNamed("/maria-screen");
            }
          ...
          child: Column(
            ...
            children: [
              Image.asset(
                'asset/logosupervisor/maria160.png',
                fit: BoxFit.contain,
                width: 45,
                height: 45,
              ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Equipe Supervisores'),
      ),
