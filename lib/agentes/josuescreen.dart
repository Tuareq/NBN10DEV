...
class JosueScreen extends StatefulWidget {
  const JosueScreen({Key? key}) : super(key: key);

  @override
  _JosueScreenState createState() => _JosueScreenState();
}

class _JosueScreenState extends State<JosueScreen> {
