...
class IracemaScreen extends StatefulWidget {
  const IracemaScreen({Key? key}) : super(key: key);

  @override
  _IracemaScreenState createState() => _IracemaScreenState();
}

class _IracemaScreenState extends State<IracemaScreen> {
