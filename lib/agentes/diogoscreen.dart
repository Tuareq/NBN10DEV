...
class DiogoScreen extends StatefulWidget {
  const DiogoScreen({Key? key}) : super(key: key);

  @override
  _DiogoScreenState createState() => _DiogoScreenState();
}

class _DiogoScreenState extends State<DiogoScreen> {
            ...
            child: Column(
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).pushNamed(
                        "/cadiogo-screen"); // Navegue para a tela do mapa
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.indigo, // Cor de fundo do botão
                    shape: RoundedRectangleBorder(
