...
class AndreiaScreen extends StatefulWidget {
  const AndreiaScreen({Key? key}) : super(key: key);

  @override
  _AndreiaScreenState createState() => _AndreiaScreenState();
}

class _AndreiaScreenState extends State<AndreiaScreen> {
