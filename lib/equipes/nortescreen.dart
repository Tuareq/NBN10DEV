...
class NorteScreen extends StatefulWidget {
  const NorteScreen({Key? key}) : super(key: key);

  @override
  _NorteScreenState createState() => _NorteScreenState();
}

class _NorteScreenState extends State<NorteScreen> {
