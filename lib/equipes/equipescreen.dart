...
class equipeScreen extends StatelessWidget {
  final List<Widget Function(BuildContext)> buttons = [
    ...
    (BuildContext context) =>
        ...
        ElevatedButton(                                                 // Botão melhor equipe
          onPressed: () async {
            ...
            if (isPasswordCorrect == true) {
              Navigator.of(context).pushNamed("/melhor-screen");
            }
          ...
          child: Column(
            ...
            children: [
              Image.asset(
                'asset/logoequipes/melhor160.png',
                fit: BoxFit.contain,
                width: 45,
                height: 45,
              ),
      ...
      onPressed: () async {
        ...
        if (isPasswordCorrect == true) {
          Navigator.of(context).pushNamed("/sul-screen");
        }
      ...
      child: Column(
        ...
        ElevatedButton(                                                   //Botão equipe coloninha
          onPressed: () async {
            ...
            if (isPasswordCorrect == true) {
              Navigator.of(context).pushNamed("/coloninha-screen");
            }
        ...
        ElevatedButton(                                                   //Botão equipe norte
          onPressed: () async {
            ...
            if (isPasswordCorrect == true) {
              Navigator.of(context).pushNamed("/norte-screen");
            }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Equipes da Dengue'),
      ),
