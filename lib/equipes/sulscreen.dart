...
class SulScreen extends StatefulWidget {
  const SulScreen({Key? key}) : super(key: key);

  @override
  _SulScreenState createState() => _SulScreenState();
}

class _SulScreenState extends State<SulScreen> {
            ...
            child: Column(
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).pushNamed(
                        "/edio-screen"); // Navegue para a tela do mapa
                  },
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).pushNamed(
                        "/josiel-screen"); // Navegue para a tela do mapa
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.indigo, // Cor de fundo do botão
                    shape: RoundedRectangleBorder(
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).pushNamed(
                        "/kelsen-screen"); // Navegue para a tela do mapa
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.indigo, // Cor de fundo do botão
                    shape: RoundedRectangleBorder(
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).pushNamed(
                        "/mariana-screen"); // Navegue para a tela do mapa
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.indigo, // Cor de fundo do botão
                    shape: RoundedRectangleBorder(
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).pushNamed(
                        "/-screen"); // Navegue para a tela do mapa
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.indigo, // Cor de fundo do botão
                    shape: RoundedRectangleBorder(
