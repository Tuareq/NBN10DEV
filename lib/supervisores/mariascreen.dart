...
class MariaScreen extends StatefulWidget {
  const MariaScreen({Key? key}) : super(key: key);

  @override
  _MariaScreenState createState() => _MariaScreenState();
}

class _MariaScreenState extends State<MariaScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Sup.Maria Emilia"),
            ...
            child: Column(
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).pushNamed(
                        "/cadmaria-screen"); // Navegue para a tela do mapa
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.indigo, // Cor de fundo do botão
                    shape: RoundedRectangleBorder(
